window.SWEETS = [
    ...
    [ 
      ...
      // 51
      {question:'オレンジの小さな立方体（3×3）が5つあります。\nこれらを全て積み上げると、灰色の大きな立方体は完成するでしょうか？',choices:['A.完成する','B.完成しない'],
      img:'../../resource/img/quizImg/quizImg51.png',
      answer:'1',qFalse:'ぶっぶ～!正解はBの「完成しない」だよ',
      info:'既に一つ積み上げていて、残りの空いている箇所が5個あるから、すべて積み上げても完成しません。'},

      // 52
      {question:'この写真に隠れている6文字のアルファベットは何？',choices:['1.S, A, K, Z, P, Q','2.S, K, D, C, B, O','3.S, A, K, Z, D, O','4.S, Z, D, O, C, F'],
      img:'../../resource/img/quizImg/quizImg52.png',
      answer:'2',qFalse:'ぶっぶ～!正解は3の「S, A, K, Z, D, O」だよ',
      info:'S（オレンジ）、A（紫）、K（緑）、Z（青）、D（赤）、O（ピンク）で描かれていました。'},

      // 53
      {question:'女性の脈ありのサインとは？',choices:['A.頷く回数が多い','B.目を見て話してくれる','C.つま先がこちらを向いている','D.口元が緩んでいる'],
      answer:'2',qFalse:'ぶっぶ～!正解はCの「つま先がこちらを向いている」だよ',
      info:'相手に興味があったり、好意を抱いている場合には、自然とつま先が相手の方向を向くのです。\nそして、更に興味深かったり、好意が大きい場合には、身をせり出すようにして会話をしている場合が多いのです。\nそのため、つま先があなたの方向へ向いていて、身を乗り出している場合には、脈ありと判断しても良いでしょう。'}, 
      
      //54
      {question:'「にっこり」の反対語は？',choices:['A.がっくり','B.げっそり','C.むっつり','D.しっとり'],
      answer:'2',qFalse:'ぶっぶ～!正解はCの「むっつり」だよ',
      info:'むっつりの意味は口数が少なく愛想の無い様なんだって。'},

      // 55
      {question:'プテラノドンやイグアノドンなどのように恐竜の名前に付けられる「ドン」の意味は？',choices:['A.首','B.歯','C.爪','D.尾'],
      answer:'1',qFalse:'ぶっぶ～!正解はBの「歯」だよ',
      info:'ギリシャ語で「歯」という意味の「odont（オドン）」が由来らしいよ。'},

      //56
      {question:'明朝体の”この部分”の名称は？',choices:['A.やま','B.うろこ','C.やり','D.とげ'],
      img:'../../resource/img/quizImg/quizImg56.png',
      answer:'1',qFalse:'ぶっぶ～!正解はBの「うろこ」だよ',
      info:'三角形を組み合わせた「鱗文（うろこもん）」と明朝体の「とめ」が似ていたことが由来みたい。'},

      // 57
      {question:'カスタネットの名前の由来となったものは？',choices:['A.はさみの刃','B.貝の殻','C.栗の実','D.両手'],
      answer:'2',qFalse:'ぶっぶ～!正解はCの「栗の実」だよ',
      info:'スペイン語で栗の実という意味のcastana（カスターニャ）が語源となっている'},

      // 58
      {question:'実在している生き物は？',choices:['A.タコイカ','B.タコエイ','C.タコサメ','D.タコウニ'],
      answer:'0',qFalse:'ぶっぶ～!正解はAの「タコイカ」だよ',
      info:'タコイカはイカの仲間で、足の数がタコと同じ8本なのでタコイカと名付けられたんだって。'},

      // 59
      {question:'スタジオジブリの「ジブリ」の意味は？',choices:['A.大空','B.樹林','C.熱風','D.月光'],
      answer:'2',qFalse:'ぶっぶ～!正解はCの「熱風」だよ',
      info:'サハラ砂漠に吹く熱風「ghibli（イタリア語）」に由来。\n日本のアニメーション界に熱風を起こそうという思いを込めて名付けた。'},

      // 60
      {question:'漢字の「人鳥（じんちょう）」が表す鳥は？',choices:['A.ペンギン','B.ダチョウ','C.オウム','D.ニワトリ'],
      answer:'0',qFalse:'ぶっぶ～!正解はAの「ペンギン」だよ',
      info:'「人鳥」という漢字になった由来は、立ち姿が人に似ていたことなんだとか。 たしかに立って歩く姿は人のようですよね！'},

      // 61
      {question:'宝石の表面に明るい筋が出来る現象は「○○効果」？',choices:['A.キャッツアイ','B.モーゼ','C.ライトスコープ','D.ムーンライト'],
      answer:'0',qFalse:'ぶっぶ～!正解はAの「キャッツアイ」だよ',
      info:'宝石に光を照らすと猫の目のような線が見えることから。'},

      // 62
      {question:'2024年発行予定の新1万円札の裏に描かれているのは？',choices:['A.東京駅','B.国技館','C.国会議事堂','D.スカイツリー'],
      answer:'0',qFalse:'ぶっぶ～!正解はAの「東京駅」だよ',
      info:'歴史的な建築物であることや紙幣の色と調和がとれる色などの理由から'},
      
      // 64
      {question:'空欄に入る動詞は？\n49＝泣く\n59＝飲む\n54＝磨く\n28＝？',choices:['A.笑う','B.怒る','C.食べる'],
      answer:'0',qFalse:'ぶっぶ～!正解はAの「笑う」だよ',
      info:'繰り返すと擬音になる\n4949＝シクシク\n5959＝ゴクゴク\n5454＝ゴシゴシ\n2828＝ニヤニヤ'},

      // 65
      {question:'空欄に入る物は？',choices:['A.えんぴつ','B.クレヨン','C.万年筆'],
      img:'../../resource/img/quizImg/quizImg65.png',
      answer:'1',qFalse:'ぶっぶ～!正解はBの「クレヨン」だよ',
      info:'数字が順に隠れている。ライチ⑴　ウニ⑵ クロワッサン⑶ クレヨン⑷'},
